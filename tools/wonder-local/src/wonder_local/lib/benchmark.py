...
class Benchmark:
    def __init__(self, label: str = "Benchmark", input_tokens: int = 0, output_tokens: int = 0):
        self.label = label
    ...
    def report(self):
        ...
        cpu_time = (self.cpu_end.user + self.cpu_end.system) - (self.cpu_start.user + self.cpu_start.system)
